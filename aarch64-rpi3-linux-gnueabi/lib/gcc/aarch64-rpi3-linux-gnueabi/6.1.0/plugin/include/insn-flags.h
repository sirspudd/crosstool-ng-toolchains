...
#define HAVE_aarch64_rsqrte_v2sf2 (TARGET_SIMD)
#define HAVE_aarch64_rsqrte_v4sf2 (TARGET_SIMD)
#define HAVE_aarch64_rsqrte_v2df2 (TARGET_SIMD)
#define HAVE_aarch64_rsqrte_sf2 (TARGET_SIMD)
#define HAVE_aarch64_rsqrte_df2 (TARGET_SIMD)
#define HAVE_aarch64_rsqrts_v2sf3 (TARGET_SIMD)
#define HAVE_aarch64_rsqrts_v4sf3 (TARGET_SIMD)
#define HAVE_aarch64_rsqrts_v2df3 (TARGET_SIMD)
#define HAVE_aarch64_rsqrts_sf3 (TARGET_SIMD)
#define HAVE_aarch64_rsqrts_df3 (TARGET_SIMD)
...
extern rtx        gen_aarch64_rsqrte_v2sf2                (rtx, rtx);
extern rtx        gen_aarch64_rsqrte_v4sf2                (rtx, rtx);
extern rtx        gen_aarch64_rsqrte_v2df2                (rtx, rtx);
extern rtx        gen_aarch64_rsqrte_sf2                  (rtx, rtx);
extern rtx        gen_aarch64_rsqrte_df2                  (rtx, rtx);
extern rtx        gen_aarch64_rsqrts_v2sf3                (rtx, rtx, rtx);
extern rtx        gen_aarch64_rsqrts_v4sf3                (rtx, rtx, rtx);
extern rtx        gen_aarch64_rsqrts_v2df3                (rtx, rtx, rtx);
extern rtx        gen_aarch64_rsqrts_sf3                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_rsqrts_df3                  (rtx, rtx, rtx);
