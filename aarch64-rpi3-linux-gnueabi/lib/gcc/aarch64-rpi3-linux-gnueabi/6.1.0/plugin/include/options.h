...
enum opt_code
{
  ...
  OPT_mbig_endian = 1181,                    /* -mbig-endian */
  OPT_mbionic = 1182,                        /* -mbionic */
  OPT_mcmodel_ = 1183,                       /* -mcmodel= */
  OPT_mcpu_ = 1184,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1185,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1186,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1187,             /* -mgeneral-regs-only */
  OPT_mglibc = 1188,                         /* -mglibc */
  OPT_mlittle_endian = 1189,                 /* -mlittle-endian */
  OPT_mlow_precision_recip_sqrt = 1190,      /* -mlow-precision-recip-sqrt */
  OPT_mmusl = 1191,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1192,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1193,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1194,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1195,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1196,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1197,                     /* -mtls-size= */
  OPT_mtune_ = 1198,                         /* -mtune= */
  OPT_muclibc = 1199,                        /* -muclibc */
  OPT_n = 1200,                              /* -n */
  ...
  OPT_static_libgcj = 1247,                  /* -static-libgcj */
